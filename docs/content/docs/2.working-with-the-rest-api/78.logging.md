...
## What the SDK redacts automatically {#what-the-sdk-redacts-automatically}
...
### Callsites that consume the redactor {#callsites-that-consume-the-redactor}
...
## Webhook URL is no longer logged {#webhook-url-is-no-longer-logged}
...
## What the SDK does not redact {#what-the-sdk-does-not-redact}
...
## Recommended pattern: wiring a custom logger {#recommended-pattern-wiring-a-custom-logger}
...
## Auditing your log archives {#auditing-your-log-archives}
...
## Advanced: reading the source {#advanced-reading-the-source}

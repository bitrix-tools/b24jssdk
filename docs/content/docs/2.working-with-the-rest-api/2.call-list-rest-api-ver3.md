...
2. **Автоматическое определение конца данных**: запросы останавливаются при получении пустого массива или если число элементов меньше размера страницы (`options.limit`).

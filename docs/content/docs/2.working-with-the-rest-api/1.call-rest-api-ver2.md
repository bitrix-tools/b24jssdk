---
title: CallV2.make
description: 'Метод для вызовов REST API Bitrix24 версии 2.'
category: 'actions'
audited: 2026-05-29
...
### Получение компании из CRM {#getting-a-crm-company}
...
регулярно превышают аxios-таймаут 30 секунд по умолчанию. При таймауте SDK
...
* **Для работы со списками:** вместо ручного управления пагинацией используйте:
  * [`CallList`](/docs/working-with-the-rest-api/call-list-rest-api-ver2/) — автоматически получает все страницы и возвращает единый результат.

...
- When calling methods [available in REST API v3](https://apidocs.bitrix24.ru/api-reference/rest-v3/index.html), the method automatically logs a warning.
::
...
### When to Use FetchListV2.make() {#when-to-use-fetchlistv2make}
...
### Automatic Warning {#automatic-warning}
...
The method implements the [Bitrix24 recommended algorithm](https://apidocs.bitrix24.ru/settings/performance/huge-data.html) for efficient work with large data volumes:
...
### REST API v2 Response Structure {#rest-api-v2-response-structure}
...
### Step-by-step processing of a large number of companies {#step-by-step-processing-of-a-large-number-of-companies}

...
## Hard Errors (thrown) {#hard-errors-thrown}
...
## Soft Errors (returned in `AjaxResult`) {#soft-errors-returned-in-ajaxresult}
...
## Retry-Triggering Codes {#retry-triggering-codes}
...
## Working with `AjaxError` {#working-with-ajaxerror}

...
### Command Formats (`options.calls`) {#command-formats-optionscalls}
...
### Batch Request Options (`options.options`) {#batch-request-options-optionsoptions}
...
## Result Item Data {#result-item-data}
...
### Getting Multiple CRM Companies {#getting-multiple-crm-companies}
...
### Init Data Storage {#init-data-storage}
...
### Delete Data Storage {#delete-data-storage}
